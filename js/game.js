        ...
        function crearMenu() {
            ...
            menu.innerHTML = `
                <div class="fixed-background">
                    ...
                    <button id="opcion1" class="menu-button">MAİN</button>
                    <button id="opcion2" class="menu-button">ARABİC</button>
                </div>
            `;
            document.body.appendChild(menu);

            document.getElementById('opcion1').addEventListener('click', function () {
                cargarScript('https://wormateserkanconnect.github.io/DV/js/gamewfc.js');
            });
